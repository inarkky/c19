...
class Twitter
{
    ...
    public function __construct(array $settings)
    {
        if (!function_exists('curl_init')) {
            throw new RuntimeException('TwitterClass::Exception::requires cURL extension to be loaded, see: http://curl.haxx.se/docs/install.html');
        }
        ...
        if (
            ...
            throw new InvalidArgumentException('Incomplete settings passed to TwitterClass');
        }
    ...
    public function request($url, $method = 'get', $data = [], $curlOptions = array())
    {
